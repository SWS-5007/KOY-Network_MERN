...
export const PoliciesComponent: FC = () => {
  const navigate = useNavigate();
  const [clickedSubject, setSubject] = useState("TermsofService");
          ...
          <div className="wrapper">
            <div className="policies-header">
              ...
              <div className="header-section_2">
                <p className="header-title">Policies & Terms</p>
              </div>
            </div>
            ...
            <div className="policies-container">
              <div className="container-left">
                <p
                  className={`text-3 ${
                    clickedSubject === "CopyrightPolicy" ? "clickedSubject" : ""
                  }`}
                  onClick={() => setSubject("CopyrightPolicy")}
                >
                  Copyright Policy
                </p>
                <p
                  className={`text-3 ${
                    clickedSubject === "TermsofService" ? "clickedSubject" : ""
                  }`}
                  onClick={() => setSubject("TermsofService")}
                >
                  Terms of Service
                </p>
                <p
                  className={`text-3 ${
                    clickedSubject === "PrivacyPolicy" ? "clickedSubject" : ""
                  }`}
                  onClick={() => setSubject("PrivacyPolicy")}
                >
                  Privacy Policy
                </p>
                <p
              ...
              <div className="container-right">
                <div
                  className={`${
                    clickedSubject === "TermsofService" ? "" : "disabled"
                  }`}
                >
                  <p className="content-titleText">Terms of Service</p>
